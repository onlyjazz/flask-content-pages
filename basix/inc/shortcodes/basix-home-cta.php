<?php
	...
	function sc_home_cta_bar($atts, $content = NULL) {
		...
		<div class="home-cta-bar <?php echo $bar_color; ?>" style="<?php if ($text_size !== '') { ?>font-size: <?php echo $text_size ?>px;<?php } ?><?php if ($bar_color == 'custom' && $custom_color !== '') { ?> background-color: <?php echo $custom_color ?>;<?php } ?><?php if ($bar_color == 'custom' && $custom_text_color !== '') { ?> color: <?php echo $custom_text_color ?>;<?php } ?>">
			<div class="text">
				<?php echo $text ?>
			</div>
			<?php if ($button_text) { ?>
		...
		<?php
		$home_cta_bar_output = ob_get_contents();
		ob_end_clean();
		return $home_cta_bar_output;
		?>
	<?php
	}

	add_shortcode('home_cta_bar', 'sc_home_cta_bar');
	...
	if (function_exists('vc_map')) {
		vc_map(array(
			"name"                    => __("Basix Home CTA", 'basix-td'),
			"description"             => __("Place directly under Full width slider", 'basix-td'),
			"base"                    => "home_cta_bar",
			"class"                   => "",
			"controls"                => "full",
			"icon"                    => "icon-basix-vc",
